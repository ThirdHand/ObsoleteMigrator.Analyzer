...
internal struct JsonValue
{
        ...
        get
        {
            switch (Type)
            {
                ...
                case JsonValueType.String:
                    return (string)_reference != string.Empty;
    ...
    public double AsNumber
    {
        get
        {
            switch (Type)
            {
                ...
                case JsonValueType.String:
                    double number;
                    if (double.TryParse((string)_reference, NumberStyles.Float, CultureInfo.InvariantCulture, out number))
                    {
                        return number;
                    }
                    else
    ...
    public DateTime? AsDateTime
    {
        get
        {
            ...
            if (IsString && DateTime.TryParse((string)_reference, out value))
            {
                return value;
            }
            else
    ...
    private class JsonValueDebugView
    {
        ...
        public object Value
        {
            get
            {
                ...
                else if (_jsonValue.IsJsonArray)
                {
                    return (JsonArray)_jsonValue._reference;
                }
                else
